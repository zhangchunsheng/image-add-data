    ...
    **/
    public function __construct(array $options) {
        if(empty($options) || empty($options['database_type'])
            ...
            throw new Db\Exception("server or username or password or database_name or database_type cann't be empty");    
        }
        $opts = array(
            \PDO::ATTR_PERSISTENT => false,
            \PDO::ATTR_ERRMODE => \PDO::ERRMODE_EXCEPTION,
    ...
    public function query($query) {
        ...
        throw new Db\ReadOnlyException("Cann't write data to reader");
    }
