...
(function ($) {
    ...
    BootstrapTable.EVENTS = {
        ...
        'mouseover-cell.bs.table': 'onMouseOverCell',
    ...
    BootstrapTable.prototype.onSearch = function (event) {
        ...
        if(this.options.beforeOnSearch) {
            this.options.beforeOnSearch();
        }
    ...
    BootstrapTable.prototype.load = function (data) {
        ...
        if (this.options.sidePagination === 'server') {
            ...
            if(this.options.showTotalCount != '') {
                $("." + this.options.showTotalCount).html(data[this.options.dataField]["count"]);
            }
            if(this.options.dataFieldRows) {
                data = data[this.options.dataField][this.options.dataFieldRows];
            } else {
